...
## C++ 对象模型
![](http://osac5rsex.bkt.clouddn.com/c++_object_model.png?imageslim)    
...
![](http://osac5rsex.bkt.clouddn.com/SingleInheritanceWithVirtualFunction.png?imageslim)
下面是一些测试：
{% codeblock  lang:cpp %} 
class A
{
...
![](http://osac5rsex.bkt.clouddn.com/multipleInheritance.png?imageslim)
...
一种做法是直接使用一个指针指向虚基类：    
![](http://osac5rsex.bkt.clouddn.com/VirtualInheritance1.png?imageslim)

另一种做法是在 vtable 中放置 virtual base class 的 offset：
![](http://osac5rsex.bkt.clouddn.com/VirtualInheritance2.png?imageslim)
